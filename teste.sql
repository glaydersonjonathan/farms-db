...
ALTER TABLE ONLY institution_project
    ADD CONSTRAINT fk_institution_institution_project FOREIGN KEY (id_institution) REFERENCES institution(id_institution);
	
	ALTER TABLE ONLY institution_project
    ADD CONSTRAINT fk_project_institution_project FOREIGN KEY (id_project) REFERENCES project(id_project);
